   ...
   function insertpublishexam() {
    ...
    function startexam(id) {
        $.ajax({
            ...
            success: function (data) {
                ...
                {alert("考试已结束，请勿再次发布");
                }else if(data=="failstate2"){alert("考试未开始，请先开始考试");}
            }
        })
    }
    ...
    function deleteexam(id) {
            $.ajax({
                ...
                datatype: "json",
                success: function (data) {
                    if(data=="success")alert("删除成功"),exam.loodtable();
                }
            })
    }
       ...
       if(checkdate()){
           ...
           if(PoisionA!=''&&PoisionB1!=''&&CourseID!=''&&ChapterID!=''&&startdate!=''&&enddate!=''&&PoisionA!='请选择'&&PoisionB1!='请选择'){
               $.ajax({
                   ...
                   datatype: "json",
                   success: function (data) {
                       if(data=="success")alert("修改成功"),setnone('exampublish'),clearExampublish(),exam.loodtable();
                   }
               })
           }else {
               alert("请输入参数");
